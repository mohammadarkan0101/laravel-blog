...
<head>
    ...
    <!-- Tailwind CSS -->
    <script src="https://cdn.jsdelivr.net/npm/@tailwindcss/browser@4?min"></script>
    <!-- Title Page -->
    <title>Home</title>
</head>
            ...
            <nav class="flex items-center justify-end gap-4">
                @auth
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="inline-block">
                        @csrf
                        <button type="submit" class="inline-block px-5 py-1.5 ml-2 text-red-600 border border-red-300 hover:border-red-500 rounded-sm text-sm leading-normal">
                            Logout
                        </button>
                    </form>
                @else
